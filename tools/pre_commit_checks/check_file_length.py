...
Limits calibrated for this project per CLAUDE.md constraints.
"""
...
def _is_excluded(file_path: Path) -> bool:
    """Return True for files excluded from size checks."""
    if file_path.name == "__init__.py":
        return True
    parts = file_path.parts
    return bool("alembic" in parts and "versions" in parts)
